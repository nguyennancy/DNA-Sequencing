...
void Structure::createBackbone1() // above N-C-C backbone
{
  ...
  box[ index(curCol + 8, midRow + 2) ] = 'O';
  box[ index(curCol + 4, midRow - 3) ] = '|';
  box[ index(curCol + 4, midRow - 2) ] = '|'; box[ index(curCol + 4, midRow - 1) ] = '|';
} // createBackbone1()
...
void Structure::createR(int position, float pH, float rpKa)
{
  if(position % 2 == 0)
  {
    ...
    box[ index(curCol, midRow - 10) ] = 'H'; box[ index(curCol + 2, midRow - 10) ] = '-'; 
    box[ index(curCol + 4, midRow - 10) ] = 'N'; 
...
void Structure::createD(int position, float pH, float rpKa)
{
  if(position % 2 == 0)
  {
    ...
    if((pH - rpKa) < 0)
    {
      box[ index(curCol + 4, midRow - 10) ] = 'H'; box[ index(curCol + 4, midRow - 9) ] = '|';
    } // if pH < pKa, protonate R - group
  ...
  else // position % 2 != 0
  {
    ...
    if((pH - rpKa) < 0)
    {
      box[ index(curCol + 4, midRow + 9) ] = '|'; box[ index(curCol + 4, midRow + 10) ] = 'H';
    } // if pH < pKa, protonate R - group
...
void Structure::createE(int position, float pH, float rpKa)
{
  if(position % 2 == 0)
  {
    ...
    if((pH - rpKa) < 0)
    {
      box[ index(curCol + 4, midRow - 12) ] = 'H'; box[ index(curCol + 4, midRow - 11) ] = '|';
    } // if pH < pKa, protonate R - group
  ...
  else // position % 2 != 0
  {
    ...
    if((pH - rpKa) < 0)
    {
      box[ index(curCol + 4, midRow + 11) ] = '|'; box[ index(curCol + 4, midRow + 12) ] = 'H';
    } // if pH < pKa, protonate R - group
...
void Structure::createG(int position)
{
  ...
  {
    // R group: H
    box[ index(curCol + 4, midRow - 5) ] = 'H'; box[ index(curCol + 4, midRow - 4) ] = '|'; 
  ...
  else // position % 2 != 0
  {
    ...
    // R group
    box[ index(curCol + 4, midRow + 4) ] = '|'; box[ index(curCol + 4, midRow + 5) ] = 'H';
  } // else odd, R group below
  curCol += 12;  
} // createG()
...
void Structure::createH(int position, float pH, float rpKa)
{
  if(position % 2 == 0)
  {
    ...
    if((pH - rpKa) < 0)
    {
      box[ index(curCol - 2, midRow - 12) ] = 'H'; box[ index(curCol, midRow - 11) ] = '\\';
  ...
  else // position % 2 != 0
  {
    ...
    if((pH - rpKa) < 0)
    {
      box[ index(curCol, midRow + 11) ] = '/'; box[ index(curCol - 2, midRow + 12) ] = 'H';
      box[ index(curCol + 2, midRow + 11) ] = '+';
    } // if pH < pKa, protonate R - group
  } // else odd, R group below
  curCol += 12;  
...
void Structure::createK(int position, float pH, float rpKa)
{
  if(position % 2 == 0)
  {
    ...
    if((pH - rpKa) < 0)
    {
      ...
      box[ index(curCol + 6, midRow - 12) ] = '-'; box[ index(curCol + 8, midRow - 12) ] = 'H';
    } // if pH < pKa, protonate R - group
  ...
  else // position % 2 != 0
  {
    ...
    if((pH - rpKa) < 0)
    {
      box[ index(curCol, midRow + 12) ] = 'H'; box[ index(curCol + 2, midRow + 12) ] = '-';
...
void Structure::createF(int position)
{
  if(position % 2 == 0)
  {
    ...
    box[ index(curCol + 4, midRow - 12) ] = 'C';
    box[ index(curCol - 3, midRow - 11) ] = '/'; box[ index(curCol + 5, midRow - 11) ] = '\\';
    box[ index(curCol - 8, midRow - 10) ] = 'H'; box[ index(curCol - 6, midRow - 10) ] = '-';
    box[ index(curCol - 4, midRow - 10) ] = 'C'; box[ index(curCol + 5, midRow - 10) ] = 'C';
    box[ index(curCol + 7, midRow - 10) ] = '-'; box[ index(curCol + 9, midRow - 10) ] = 'H';
    box[ index(curCol - 3, midRow - 9) ] = '\\'; box[ index(curCol - 2, midRow - 9) ] = '\\';
    box[ index(curCol + 4, midRow - 9) ] = '/'; box[ index(curCol + 5, midRow - 9) ] = '/';
    box[ index(curCol - 2, midRow - 8) ] = 'C'; box[ index(curCol + 1, midRow - 8) ] = '-';
  ...
  else // position % 2 != 0
  {
    ...
    box[ index(curCol + 10, midRow + 8) ] = 'C';
    box[ index(curCol + 3, midRow + 9) ] = '/'; box[ index(curCol + 4, midRow + 9) ] = '/';
    box[ index(curCol + 10, midRow + 9) ] = '\\'; box[ index(curCol + 11, midRow + 9) ] = '\\';
    box[ index(curCol - 2, midRow + 10) ] = 'H'; box[ index(curCol, midRow + 10) ] = '-';
    box[ index(curCol + 2, midRow + 10) ] = 'C'; box[ index(curCol + 11, midRow + 10) ] = 'C';
    box[ index(curCol + 13, midRow + 10) ] = '-'; box[ index(curCol + 15, midRow + 10) ] = 'H';
    box[ index(curCol + 3, midRow + 11) ] = '\\'; box[ index(curCol + 11, midRow + 11) ] = '/';
    box[ index(curCol + 4, midRow + 12) ] = 'C'; box[ index(curCol + 7, midRow + 12) ] = '=';
    box[ index(curCol + 10, midRow + 12) ] = 'C';
...
void Structure::createP(int position)
{
  ...
  else // position % 2 != 0
  {
    ...
    // backbone
    box[ index(curCol - 1, midRow) ] = '-';
    box[ index(curCol, midRow) ] = '-'; box[ index(curCol + 1, midRow) ] = '-';
    box[ index(curCol + 2, midRow) ] = '-'; box[ index(curCol + 4, midRow) ] = 'N'; 
    box[ index(curCol + 6, midRow) ] = '-'; box[ index(curCol + 7, midRow) ] = '-'; 
    box[ index(curCol + 8, midRow) ] = '-'; box[ index(curCol + 10, midRow) ] = 'C'; 
    box[ index(curCol + 12, midRow) ] = '-'; box[ index(curCol + 13, midRow) ] = '-'; 
    box[ index(curCol + 14, midRow) ] = '-'; box[ index(curCol + 16, midRow) ] = 'C';
    box[ index(curCol + 18, midRow) ] = '-';
    box[ index(curCol + 19, midRow) ] = '-'; box[ index(curCol + 20, midRow) ] = '-';
    box[ index(curCol + 10, midRow + 1) ] = '|'; box[ index(curCol + 16, midRow + 1) ] = '|';
    box[ index(curCol + 17, midRow + 1) ] = '|';
    box[ index(curCol + 10, midRow + 2) ] = 'H'; box[ index(curCol + 16, midRow + 2) ] = 'O';
...
void Structure::createW(int position)
{
  if(position % 2 == 0)
  {
    ...
    box[ index(curCol + 8, midRow - 13) ] = '/';
    box[ index(curCol - 12, midRow - 12) ] = 'H'; box[ index(curCol - 10, midRow - 12) ] = '-';
    box[ index(curCol - 8, midRow - 12) ] = 'C'; box[ index(curCol + 2, midRow - 12) ] = 'C';
    box[ index(curCol + 4, midRow - 12) ] = '-'; box[ index(curCol + 5, midRow - 12) ] = '-';
    box[ index(curCol + 7, midRow - 12) ] = 'N';  
    box[ index(curCol - 7, midRow - 11) ] = '\\'; box[ index(curCol - 6, midRow - 11) ] = '\\';
    box[ index(curCol, midRow - 11) ] = '/'; box[ index(curCol + 1, midRow - 11) ] = '/';
    box[ index(curCol + 8, midRow - 11) ] = '\\';
    box[ index(curCol - 6, midRow - 10) ] = 'C'; box[ index(curCol - 3, midRow - 10) ] = '-';
    box[ index(curCol, midRow - 10) ] = 'C'; box[ index(curCol + 9, midRow - 10) ] = 'C';
    box[ index(curCol - 7, midRow - 9) ] = '/'; box[ index(curCol + 1, midRow - 9) ] = '\\';
    box[ index(curCol + 7, midRow - 9) ] = '/'; box[ index(curCol + 8, midRow - 9) ] = '/';
    box[ index(curCol - 8, midRow - 8) ] = 'H'; box[ index(curCol + 4, midRow - 8) ] = 'C';
    for(int i = 0; i < 4; i++)
  ...
  else // position % 2 != 0
  {
    ...
    box[ index(curCol + 15, midRow + 11) ] = '\\';
    box[ index(curCol + 1 , midRow + 12) ] = 'N'; box[ index(curCol + 4, midRow + 12) ] = '-';
    box[ index(curCol + 7, midRow + 12) ] = 'C'; box[ index(curCol + 16, midRow + 12) ] = 'C';
    box[ index(curCol + 18, midRow + 12) ] = '-'; box[ index(curCol + 20, midRow + 12) ] = 'H'; 
    box[ index(curCol, midRow + 13) ] = '/';
    box[ index(curCol + 7, midRow + 13) ] = '\\'; box[ index(curCol + 16, midRow + 13) ] = '/';
    box[ index(curCol - 2, midRow + 14) ] = 'H'; 
    box[ index(curCol + 8, midRow + 14) ] = 'C'; box[ index(curCol + 11, midRow + 14) ] = '=';
    box[ index(curCol + 14, midRow + 14) ] = 'C';
...
void Structure::createY(int position, float pH, float rpKa)
{
  if(position % 2 == 0)
  {
    ...
    box[ index(curCol + 4, midRow - 13) ] = 'C';
    box[ index(curCol - 3, midRow - 12) ] = '/'; box[ index(curCol + 5, midRow - 12) ] = '\\';
    box[ index(curCol - 8, midRow - 11) ] = 'H'; box[ index(curCol - 6, midRow - 11) ] = '-';
    box[ index(curCol - 4, midRow - 11) ] = 'C'; box[ index(curCol + 5, midRow - 11) ] = 'C';
    box[ index(curCol + 7, midRow - 11) ] = '-'; box[ index(curCol + 9, midRow - 11) ] = 'H';
    box[ index(curCol - 3, midRow - 10) ] = '\\'; box[ index(curCol - 2, midRow - 10) ] = '\\';
    box[ index(curCol + 4, midRow - 10) ] = '/'; box[ index(curCol + 5, midRow - 10) ] = '/';
    box[ index(curCol - 2, midRow - 9) ] = 'C'; box[ index(curCol + 1, midRow - 9) ] = '-';
    box[ index(curCol + 4, midRow - 9) ] = 'C';
  ...
  else // position % 2 != 0
  {
    ...
    box[ index(curCol + 10, midRow + 9) ] = 'C';
    box[ index(curCol + 3, midRow + 10) ] = '/'; box[ index(curCol + 4, midRow + 10) ] = '/';
    box[ index(curCol + 10, midRow + 10) ] = '\\'; box[ index(curCol + 11, midRow + 10) ] = '\\';
    box[ index(curCol - 2, midRow + 11) ] = 'H'; box[ index(curCol, midRow + 11) ] = '-';
    box[ index(curCol + 2, midRow + 11) ] = 'C'; box[ index(curCol + 11, midRow + 11) ] = 'C';
    box[ index(curCol + 13, midRow + 11) ] = '-'; box[ index(curCol + 15, midRow + 11) ] = 'H';
    box[ index(curCol + 3, midRow + 12) ] = '\\'; box[ index(curCol + 11, midRow + 12) ] = '/';
    box[ index(curCol + 4, midRow + 13) ] = 'C'; box[ index(curCol + 7, midRow + 13) ] = '=';
    box[ index(curCol + 10, midRow + 13) ] = 'C';
